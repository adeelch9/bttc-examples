...
contract GovernorAlpha {
    ...
    function votingPeriod() public pure returns (uint) { return 604800; } // ~7 days in blocks (assuming 1s blocks)
    ...
    function queue(uint proposalId) public {
        ...
        uint eta = add256(block.timestamp.div(1000), timelock.delay());
    ...
    function state(uint proposalId) public view returns (ProposalState) {
        ...
        } else if (block.timestamp.div(1000) >= add256(proposal.eta, timelock.GRACE_PERIOD())) {
    ...
    function castVoteBySig(uint proposalId, bool support, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(signatory != address(uint160(0)), "GovernorAlpha::castVoteBySig: invalid signature");
